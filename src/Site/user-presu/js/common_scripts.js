...
$.extend($.validator, {
	...
	messages: {
		...
		creditcard: "Ingrese una tarjeta de credito valida.",
		equalTo: "Ingrese el mismo valor nuevamente.",
		maxlength: $.validator.format("Ingrese no menos de {0} caracteres."),
		minlength: $.validator.format("Ingrese al menos {0} caracteres."),
		rangelength: $.validator.format("Ingrese un valor entr {0} y {1} caracteres."),
		range: $.validator.format("Ingrese un valor entr {0} y {1}."),
