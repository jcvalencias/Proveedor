          ...
          <div className="col-lg-6">
            <div className="features-content-box features-content-box-one">
              ...
              <h5>
                ...
                ultricies aenean quam eros eleifend sodales cubilia mattis quam.
              </h5>
                ...
                <li className="list-item wow fadeInUp" data-wow-delay="10ms">
                  ...
                  <div className="content">
                    ...
                    <p>
                      ...
                      sociis facilisi aenean netus tempor duis.
                    </p>
                  </div>
                </li>
        ...
        <div className="row">
          ...
          <div className="col-lg-7">
            <div className="download-content-box download-content-box-one">
              ...
              <p>
                Dictumst integer tellus eros quam vestibulum ante tortor mollis
                adipisn pharetra curae curae and pulvinar porttitor
              </p>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="copyright-text">
                <p>
                  Copyright © 2021. All rights reserved to <span>Webtend</span>
                </p>
              </div>
            </div>
            <div className="col-lg-6">
